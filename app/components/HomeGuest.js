    ...
    switch (action.type) {
      case "usernameImmediately":
        ...
        if (draft.username.value.length > 30) {
          ...
          draft.username.message = "Username cannont exceed 30 characters"
        }
      ...
      case "emailAfterDelay":
        if (!/^\S+@\S+$/.test(draft.email.value)) {
          ...
          draft.email.message = "You must provided a valid email address"
        }
      ...
      case "passwordImmediately":
        ...
        if (draft.password.value.length > 50) {
          ...
          draft.password.message = "Password cannont exceed 50 characters"
        }
        return
    ...
    if (state.username.checkCount) {
      ...
      async function fetchResults() {
        try {
          ...
          console.log("There was an error with homeguest-unique username request")
    ...
    if (state.email.checkCount) {
      ...
      async function fetchResults() {
        try {
          ...
          console.log("There was an error with homeguest-unique email request")
          console.log(e.response.data)
        }
      }
      fetchResults()
    ...
    if (state.submitCount) {
      ...
      async function fetchResults() {
        try {
          ...
          console.log("There was an error with homeguest-register")
          console.log(e.response.data)
        }
      }
      fetchResults()
